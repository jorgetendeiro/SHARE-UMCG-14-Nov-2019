...
So, for instance, the odds of not making it after hospital discharge increase by about `r round(exp(coef(icu.freq)["cancerYes"]), 0)` times for cancer patients. 
...
What is the probaiblity of the odds ratio being larger than 1?
